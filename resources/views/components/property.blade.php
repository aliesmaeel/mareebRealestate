<div class="card">
    ...
    <div class="flex location_property">
        ...
        <a href="#">
            <div>Burj Al Nujoom, Downtown, Dubai </div>
        </a>
    </div>
    <div class="details_property">
        <div class="flex">
            <svg class="svg-inline--fa fa-bed" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="bed" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" data-fa-i2svg="">
                <path fill="#927c75" d="M32 32c17.7 0 32 14.3 32 32V320H288V160c0-17.7 14.3-32 32-32H544c53 0 96 43 96 96V448c0 17.7-14.3 32-32 32s-32-14.3-32-32V416H352 320 64v32c0 17.7-14.3 32-32 32s-32-14.3-32-32V64C0 46.3 14.3 32 32 32zm144 96a80 80 0 1 1 0 160 80 80 0 1 1 0-160z">
                </path>
            </svg>
            <div>4</div>
        </div>
        <div class="flex">
            <img src="/images/icons8-water-50.png">
            <div>5</div>
        </div>
        <div class="flex">
    ...
    <div class="property_owner">
        <div class="flex">
            <img class="person" src="https://savoirbucket.s3.eu-north-1.amazonaws.com/storage/image/Agent/vessela-Savoir.jpg">
            <a class="name" href="#">
                Vessela Nedialkova
            </a>
        </div>
