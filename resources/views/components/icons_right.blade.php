<div class="icon-fixed">
    <div class="flex-col">
        <a href="https://wa.me/+971524379679"  class="whatsapp-fixed">
        ...
        <div class="flex-row">
            <a href="mailto:info@meerabproperties.ae">
            ...
            {{-- <a href="#" class="to-top">
                <svg class="svg-inline--fa fa-chevron-up" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="chevron-up" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
