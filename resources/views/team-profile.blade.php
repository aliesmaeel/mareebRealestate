...
{{-- main page --}}
@section('content')
<div class="container team_profile">
    <div class="content first_sction">
        <div class="flex-container">
            <div class="col flex-col">
                <a href="#">Home | NAIN MENDOZA</a>
                <div class="name">NAIN MENDOZA</div>
                <div class="text-infor">  Senior Global Real Estate Advisor</div>
                <div class="flex buttons">
                    ...
                    <a hrf="#">
                        ...
                        <div>Click to WhatsApp</div>
                    </a>
                </div>
                <div class="bio-info">
                    <div class="title">Bio</div>
                    <div class="desc">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt cumque rem molestias fugiat provident quasi maiores voluptatem beatae, impedit aliquam nulla voluptates in animi. Recusandae nemo debitis praesentium consectetur expedita.
                        <br><br>
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nesciunt accusantium pariatur eum numquam sit odio reprehenderit tempore, fuga nostrum quo vel quisquam, non maiores iure quis quia perspiciatis? Laboriosam, veniam.
                    </div>
                </div>
            </div>
    ...
    <div class="work_together">
        <div class="content">
            <div>WE’RE READY TO HELP</div>
            <div class="title">Let’s work together.</div>
            <div class="desc">
                Looking to sell, buy, or rent a property in Dubai? We’re here to help.
            </div>
